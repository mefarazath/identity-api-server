 ...
 * Mapper Function.
 */
public class ApplicationToExternalModel implements Converter<ServiceProvider, ApplicationModel> {
    ...
    @Override
    public ApplicationModel convert(ServiceProvider application) {
    ...
    private OpenIDConnectConfiguration buildOpenIdConnectConfiguration(InboundAuthenticationRequestConfig inboundAuth) {
        ...
        try {
            ...
            return new OAuthConsumerAppToExternalModel().convert(oauthApp);
    ...
    private SAML2Configuration buildSaml2Configuration(InboundAuthenticationRequestConfig inboundAuth) {
        ...
        try {
            ...
            if (serviceProvider != null) {
                return new SAMLSSOServiceProviderToExternalModel().convert(serviceProvider);
            } else {
                return null;
            }
