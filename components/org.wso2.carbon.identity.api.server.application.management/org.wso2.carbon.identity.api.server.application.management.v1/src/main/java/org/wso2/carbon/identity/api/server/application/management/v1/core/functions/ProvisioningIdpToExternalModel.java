...
/**
 * Converts provisioning IDP configuration of an application to external model.
 */
public class ProvisioningIdpToExternalModel implements Converter<IdentityProvider, OutboundProvisioningConfiguration> {

    @Override
    public OutboundProvisioningConfiguration convert(IdentityProvider identityProvider) {
