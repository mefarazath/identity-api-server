...
/**
 * Convert an application external object to an Application object to be consumed by backend service.
 */
public class ExternalModelToApplication implements Converter<ApplicationModel, ServiceProvider> {

    @Override
    public ServiceProvider convert(ApplicationModel applicationModel) {
